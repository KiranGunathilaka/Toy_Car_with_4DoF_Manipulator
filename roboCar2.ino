...
const int CODE_DRIVE_FORWARD = 294; // Start + Up arrow
const int CODE_DRIVE_BACK = 287;    // Start + Down arrow
const int CODE_DRIVE_LEFT = 308;    // Start + Left arrow (spins left)
const int CODE_DRIVE_RIGHT = 336;   // Start + Right arrow (spins right)
...
const int STEER_CENTER = 100;       // Wheels pointing straight (middle position)
...
int elbowPos = 80;           // Where the elbow is (starts at middle)
...
/************ 🛠️ HELPER FUNCTIONS - Useful tools the robot uses ************/
...
void setup()
{
  ...
  // ===== SETUP BLUETOOTH =====
  Dabble.begin("TechnoBlade Robot 2");  // Start Bluetooth with this name (you'll see this on your phone)
  ...
  Serial.println("\n⚠️  If servos don't work, check wiring to pins:");
